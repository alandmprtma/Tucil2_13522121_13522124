...
function BruteforceClient({points, inputPoints}) {
  ...
  const sortedInput = inputPoints.slice().sort((a, b) => a.x - b.x);
  ...
  return (
    ...
    <CartesianGrid strokeDasharray="3 3" />
        ...
        <Legend />
        <Line type="linear" dataKey="y" name="Bezier Curve" stroke="#8884d8" data={map} dot={{ fill: 'blue' }} />
...
export default function Bruteforce() {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-between p-24">
      ...
      before:w-full sm:before:w-[1000px] before:-translate-x-1/2 before:rounded-full before:bg-gradient-radial 
      before:from-white before:to-transparent before:blur-2xl before:content-[''] after:absolute after:-z-20 
      after:h-[180px] after:w-full sm:after:w-[800px] after:translate-x-1/3 after:bg-gradient-conic after:from-sky-200 
